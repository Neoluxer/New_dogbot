...
"""
    ...
    async def add_dogs(self, naming: str = 'noname', breed: str = 'no breed', weight: float = 0.5,
                       birthday: str = '01.01.01',
                       link: str = '0', picture_path: str = 'no picture', picture_link: str = 'no link',
                       dog_height: float = 10, gender: str = 'no gender'):
        sql = """
        INSERT INTO Dogs(naming,breed,weight,birthday,link,picture_path,picture_link,dog_height,gender) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9)
        """
        await self.pool.execute(sql, naming, breed, weight, birthday, link, picture_path, picture_link, dog_height,
                                gender)
